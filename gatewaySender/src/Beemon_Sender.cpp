...
Placa : Lillygo GSM7000E
Comentarios: En Arduino IDE para imprimir por el serial se ha de habilitar :  Tools > USB CDC On Boot > Enabled
Descripcion:  Codigo para el Reciver-sender 
  - Receiver de los datos de las colmenas
  - Sender de los datos a la plataforma TagoIO via Mqtt
Versiones:
- V1: Version inicial
*/ 
