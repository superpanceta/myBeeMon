/*
Codigo para el sender
Sera el mismo para todas las colmenas , cambiando solamente el ID  y la calibracion de las celdas de carga
*/ 

#include <Arduino.h>     // Needed for Visual Studio Code
#include <ESP8266WiFi.h> // Wifi para ESP8266
#include <DHTesp.h>      // Sensor temp y humedad
//#include <DHT_U.h>
#include <espnow.h> // Transmision entre ESPs
